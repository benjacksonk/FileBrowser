<script lang="ts">
    import { DetailLayout, PropertyType, type FileGroup } from "$lib/types.svelte";
...
>
    ...
    >
        ...
        <FileUI {file} {textSize} {previewSize} {detailLayout} {maxShownProperties} {showFileExtension} 
        hiddenProperties={
            showFileExtension ? 
